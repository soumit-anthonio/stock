...
print('Your STOCK DATA hervesting continue')
# a = Util()
# print(a.is_valid_code('tcs'))
# df = DataFrame(a.get_top_gainers(), columns=[
#     'symbol', 'series', 'previousPrice', 'openPrice', 'highPrice', 'lowPrice', 'ltp', 'tradedQuantity'])
# # df = DataFrame(a.get_top_gainers())
# Export = df.to_json(r'E:/stock/data/_data_top_gainer.json', orient='index')
# print('Your top gainer STOCK DATA already downloaded in the data folder')

# df = DataFrame(a.get_top_losers(), columns=[
#     'symbol', 'series', 'previousPrice', 'openPrice', 'highPrice', 'lowPrice', 'ltp', 'tradedQuantity'])
# # df = DataFrame(a.get_top_gainers())
# Export = df.to_json(r'E:/stock/data/_data_top_looser.json', orient='index')
# print('Your top looser STOCK DATA already downloaded in the data folder')

# df = DataFrame(a.get_quote('TCS'))
